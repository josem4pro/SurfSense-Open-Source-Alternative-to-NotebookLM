...
from surfsense_app.db import get_async_session, User, SearchSourceConnector, SearchSourceConnectorType, SearchSpace, async_session_maker
from surfsense_app.schemas import SearchSourceConnectorCreate, SearchSourceConnectorUpdate, SearchSourceConnectorRead, SearchSourceConnectorBase
from surfsense_app.users import current_active_user
from surfsense_app.utils.check_ownership import check_ownership
from pydantic import BaseModel, Field, ValidationError
from surfsense_app.tasks.connectors_indexing_tasks import index_slack_messages, index_notion_pages, index_github_repos, index_linear_issues
from surfsense_app.connectors.github_connector import GitHubConnector
